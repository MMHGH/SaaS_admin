  ...
  <div class="update-price-config-wrapper">
    ...
    <div class="main">
      <el-form ref="form" :model="form" :rules="formRules" size="small" label-position="right"
        ...
        <el-form-item>
          <el-button native-type="submit" type="primary" size="medium" @click.stop.prevent="updatePlatformUsageFee">保存</el-button>
...
<script>
  export default {
    ...
    methods: {
      ...
      // 更新平台使用费
      updatePlatformUsageFee(){
        this.$refs['form'].validate((valid) => {
          if(valid){
            this.$service.postWithConfirm({
              confirmText: '此操作将更新平台使用费, 是否继续？',
